...
module.exports = async function(deployer, network) {
  ...
  return deployer
    ...
    .then(async () => {
      ...
      await sausageInstance.mintUniqueTokenTo(
        auctionAddress,
        sausageID,
        sausageDescription
      )
      ...
      console.log('\n')
      console.log(
        `************* MIGRATIONS SUCCESSFULLY LAUNCHED AUCTION. SEE BELOW *************`
      )
      console.log('\n')
      ...
      console.log(
        `************* BELOW WE RUN A SCRIPT TO MAKE 100 BIDS SO THE SUBGRAPH HAS SOMETHING TO TRACK! *************`
      )
      ...
      console.log(
        `************* NEXT WE WILL MAKE AN AUCTION THAT ENDS RIGHT AWAY, TO GET event LogAcountClosed() TO TEST THE GRAPH *************`
      )
      let sausageID2 = 1111
