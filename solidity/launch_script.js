...
let source = fs.readFileSync("./build/Auction.json");
let contracts = JSON.parse(source)["contracts"];

// ABI description as JSON structure
let abi = JSON.parse(contracts.Auction.abi);

// Smart contract EVM bytecode as hex
let code = '0x' + contracts.Auction.bin;

// Create Contract proxy class
let AuctionContract = web3.eth.contract(abi);
...
let contract = AuctionContract.new({from: web3.eth.coinbase, gas: 1000000, data: code});
