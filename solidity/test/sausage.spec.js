...
var SausageTokens = artifacts.require("SausageTokens");

contract('Testing sausage contract', function(accounts) {
    ...
    it(' should be able to deploy and mint sausage token', async () => {
        token = await SausageTokens.new(name, symbol)
